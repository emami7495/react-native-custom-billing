...
import static com.util.IabHelper.BILLING_RESPONSE_RESULT_OK;
import static com.util.IabHelper.IABHELPER_ERROR_BASE;
import static com.util.IabHelper.IABHELPER_MISSING_TOKEN;
import static com.util.IabHelper.RESPONSE_BUY_INTENT;
import static com.util.IabHelper.getResponseDesc;
...
import com.util.communication.BillingSupportCommunication;
import com.util.communication.OnBroadCastConnectListener;
...
public class BroadcastIAB extends IAB {
    ...
    private static final String myketBaseAction = "ir.mservices.market.";
    private static final String myketPostAction = ".iab";

    private static final int MYKET_VERSION_CODE_WITH_BROADCAST = 900;

    public static final String pingAction = myketBaseAction + "ping";
    public static final String billingSupport = myketBaseAction + "billingSupport";
    public static final String purchaseAction = myketBaseAction + "purchase";
    public static final String skuDetailAction = myketBaseAction + "skuDetail";
    public static final String getPurchaseAction = myketBaseAction + "getPurchase";
    public static final String consumeAction = myketBaseAction + "consume";

    public static final String receivePingAction = pingAction + myketPostAction;
    public static final String receiveBillingSupport = billingSupport + myketPostAction;
    public static final String receivePurchaseAction = purchaseAction + myketPostAction;
    public static final String receiveSkuDetailAction = skuDetailAction + myketPostAction;
    public static final String receiveGetPurchaseAction = getPurchaseAction + myketPostAction;
    public static final String receiveConsumeAction = consumeAction + myketPostAction;
    ...
    boolean connect(Context context, OnBroadCastConnectListener listener) {
        try {
            ...
            if (versionCode > MYKET_VERSION_CODE_WITH_BROADCAST) {
                createIABReceiver();
                registerBroadcast();
                trySendPingToMyket();
    ...
    private Intent getNewIntentForBroadcast() {
        ...
        String myketPackageName = MYKET_PACKAGE_NAME;
